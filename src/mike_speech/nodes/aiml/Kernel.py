...
class Kernel:
    ...
    def __init__(self):
        ...
        self._botPredicates = {}
        self.setBotPredicate("name", "Mike")
        self.setBotPredicate("master", "Roberto Rodriguez")
        self.setBotPredicate("botmaster", "creator")
        self.setBotPredicate("email", "prfiredragon@gmail.com")
